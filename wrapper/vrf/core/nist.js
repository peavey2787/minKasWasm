// nist.js
// Full scaffolding for NIST SP 800-22 randomness test suite
...
import { nonOverlappingTemplateTest, overlappingTemplateTest } from './tests/template-matching.js';
import { spectralDFTTest } from './tests/spectral-dft.js';
import { maurerUniversalTest } from './tests/maurer-universal.js';
import { randomExcursionsTest, randomExcursionsVariantTest } from './tests/random-excursions.js';
...
export async function runNistSuite(bits, onProgress) {
    ...
    for (let i = 0; i < tests.length; i++) {
        ...
        try {
            ...
            result = { testName: fn.name, passed: false, statistic: null, pValue: null, threshold: null, details: { error: e.message } };
        }
